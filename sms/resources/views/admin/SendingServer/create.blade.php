                            ...
                            <div class="card-body">
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        @if($server['settings'] == SendingServer::TYPE_EMISRI)
                                        ...
                                        @if($server['settings'] == 'GatewaySa' || $server['settings'] == 'SendPulse' || $server['settings'] == SendingServer::TYPE_DIGINTRA || $server['settings'] == SendingServer::TYPE_TONKRA || $server['settings'] == SendingServer::TYPE_MTN)
                                        ...
                                        @if($server['settings'] == 'SendPulse' || $server['settings'] == SendingServer::TYPE_MTN)
