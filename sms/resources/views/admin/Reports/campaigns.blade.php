                    ...
                    },
                    {
                        ...
                        render: function (data, type, full) {
                            ...
                            if (full['camp_status'] === 'sending' || full['camp_status'] === 'paused' || full['camp_status'] === 'error') {
                                $actions += '<span class="action-delivered text-success cursor-pointer me-1" data-bs-toggle="tooltip" data-bs-placement="top" title="' + full['mark_delivered'] + '" data-id=' + full['uid'] + '>' +
