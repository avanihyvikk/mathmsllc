                ...
                <div class="bs-stepper-content">
                    ...
                    <div id="cart" class="content" role="tabpanel" aria-labelledby="cart-trigger">
                        ...
                        <div class="row mt-1 mb-1">
                            <h5>{{ __('locale.plans.price') }}: <span
                                        class="text-primary">{{ \App\Library\Tool::format_price($request->get('add_unit'), Auth::user()->customer->subscription->plan->currency->format) }} </span>
                            </h5>
                            <h5>{{ __('locale.plans.number_of_units') }}: <span
                                        class="text-primary">{{ $request->get('sms_unit') }}</span></h5>
                        </div>
                    ...
                    <div id="payment" class="content" role="tabpanel" aria-labelledby="payment-trigger">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <input type="hidden" value="{{ $request->get('sms_unit') }}" name="sms_unit">
                            <input type="hidden" value="{{ $request->get('add_unit') }}" name="balance">
