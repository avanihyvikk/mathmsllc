    ...
    <div class="col-sm-9">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-group">
                <label for="formSetting-week-starts-on"><?php echo lang('App.week_starts_on') ?></label>
                <select name="week_starts_on" id="week_starts_on" class="form-control select2">
                    <?php
                    $days = ['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'];
                    foreach ($days as $day) {
                        $selected = setting('week_starts_on') == $day ? 'selected' : '';
            ...
            <div class="form-group">
                <label for="formSetting-week-starts-on"><?php echo lang('App.event_time_format') ?></label>
                <select name="event_time_format" id="event_time_format" class="form-control select2">
                    <?php
                    $timeformat = ['12 Hour', '24 Hour'];
                    foreach ($timeformat as $time) {
                        $selected = setting('event_time_format') == $time ? 'selected' : '';
                        echo "<option value=\"$time\" $selected>" . ucfirst($time) . "</option>";
                    }
                    ?>
                </select>
            </div>
