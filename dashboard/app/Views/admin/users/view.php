            ...
            <div class="card">
              <div class="card-header d-flex p-0">
                ...
                <ul class="nav nav-pills ml-auto p-2">
					...
					<li class="nav-item"><a class="nav-link" href="<?php echo url('users/onboard_status/'.$user->id) ?>">Onboarding Status</a></li>
...
<tr>
    ...
    <!-- Display Manager's Full Name -->
    <td><?= htmlspecialchars($user->manager_full_name) ?></td>
</tr>
<tr>
    <td><strong>Location</strong>:</td>
    <!-- Display Assigned Locations -->
    <td><?= htmlspecialchars($user->assigned_locations) ?></td>
</tr>
