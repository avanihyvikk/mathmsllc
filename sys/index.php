...
if (isset($_POST['login'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $user['password'])) {
            ...
            session_start();
            $_SESSION['user_id'] = $user['id'] ?? null; // Use null coalescing operator to handle undefined 'id'
        ...
        // More than one user with the given username found
        $error = "Multiple users found with the same username. Contact administrator.";
    }
}
?>
                                        ...
                                        <div class="alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    ...
                                                    <div class="text-dark"><?php echo $error; ?></div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" method="post" action="authenticate.php">
                                            <div class="col-12">
                                                ...
                                                <input type="text" class="form-control" id="inputUsername" name="username" placeholder="Greg">
                                            </div>
                                            <div class="col-12">
                                                <label for="inputPassword" class="form-label">Password</label>
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password" class="form-control border-end-0" id="inputPassword" name="password" placeholder="Enter Password">
