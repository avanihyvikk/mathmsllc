                            ...
                            <div class="row">
                                <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                                    ...
                                    <p class="mb-0 text-dark-grey f-14 w-70">
                                        {{ $jobOffer->jobApplication ? ucfirst($jobOffer->jobApplication->full_name) : '--' }}</p>
                                </div>
                                <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                                    <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">
                                        @lang('recruit::modules.jobApplication.email')</p>
                                    <p class="mb-0 text-dark-grey f-14 w-70">
                                        {{ $jobOffer->jobApplication ? ucfirst($jobOffer->jobApplication->email) : '--' }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="row">
										...
										<div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                                            <p class="mb-0 text-lightest f-14 w-30 d-inline-block text-capitalize">
                                                Terms</p>
                                            <p class="mb-0 text-dark-grey f-14 w-70">
                                                Please note that this offer is contingent on a successful background and reference check.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
