...
<html lang="en">
    ...
    <body class="content-wrapper">
        <table class="bg-white" border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation">
                ...
                <td class="f-14 text-black">
                    ...
                    @if(is_null($salaryStructure))
                        <p class="line-height mb-0">
                            {{ currency_format($jobOffer->comp_amount, $currency->id) }} @lang('recruit::modules.joboffer.per') {{ $jobOffer->job->pay_according }}</p>
                    @endif
			...
			<tr>
                <td class="f-14 text-black">
                    <p class="line-height mb-0">Terms</p>
                   
                </td>
                <td class="f-14 text-black">
                    <p class="line-height mb-0">Please note that this offer is contingent on a successful background and reference check.</p>
                    ...
                    <td>
                        <table class="f-14 b-collapse" width="100%">
                            ...
                            @foreach ($selectedEarningsComponent as $item)
                                <tr>
                                    <td>{{ ucfirst($item->component_name) }}</td>
