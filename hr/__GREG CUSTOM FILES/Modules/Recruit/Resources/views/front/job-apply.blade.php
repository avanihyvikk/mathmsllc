                                ...
                                <div class="row p-20">
                                        ...
                                        <x-forms.input-group>
                                            <select class="form-control multiple-users" multiple name="skill_id[]"
                                                ...
                                                @forelse ($skills as $skill)
                                                    <option
                                                        data-content="<span class='badge badge-pill badge-light border'><div class='d-inline-block mr-1'></div> {{ ucfirst($skill->skill->name) }}</span>"
                                    ...
                                    <div class="col-md-4">
										...
										<x-forms.label fieldRequired="false" class="mt-3" fieldId="currenct_ctc_rate"
                                                       :fieldLabel="__('recruit::modules.jobApplication.currentCtc') . ' Frequency '"
                                        >
                                        </x-forms.label>
                                        <x-forms.input-group>
                                    ...
                                    <div class="col-md-4">
                                        <x-forms.label fieldRequired="false" class="mt-3" fieldId="expected_ctc_rate"
                                                       :fieldLabel="__('recruit::modules.jobApplication.expectedCtc') . ' Frequency '"
                                        >
                                        </x-forms.label>
                                        <x-forms.input-group>
                                    ...
                                    <div class="col-md-4">
                                        <x-forms.select fieldId="source" fieldName="source"
                                            ...
                                            @foreach ($applicationSources as $source)
                                                <option
                                                    value="{{$source->id}}"> {{ ucfirst($source->application_source) }}</option>
                                            @endforeach
                                        </x-forms.select>
                                    </div>
                                </div>
