...
class cdformReturn extends BaseNotification
{
    /**
    ...
    {
        return parent::build()
            ->subject(__('cdform::app.cdformReturn'))
            ->greeting(__('email.hello').' '.$notifiable->name.'!')
            ->line(__('cdform::app.cdformReturnMessageForMail'))
            ...
            //phpcs:ignore
            ->line(__('cdform::app.dateOfReturn').': '.(! is_null($this->history->date_of_return) ? $this->history->date_of_return->format('d F Y H:i A') : '-'))
            ->line(__('cdform::app.lendBy').': '.$this->history->lender->name)
            ->line(__('cdform::app.returnedBy').': '.$this->history->returner->name)
