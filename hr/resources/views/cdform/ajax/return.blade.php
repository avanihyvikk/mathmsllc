<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('cdform::app.returncdform')</h5>
        ...
        <x-form id="returnTo" method="PUT" class="ajax-form">
            ...
            <div class="form-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <x-forms.label fieldId="cdform_type_id" :fieldLabel="__('cdform::app.dateGiven')"/>
                        <p class="simple-text">
                    ...
                    <div class="col-md-6">
                        <x-forms.label fieldId="cdform_type_id" class="mt-3" :fieldLabel="__('cdform::app.returnDate')"/>
                        <p class="simple-text">
                    ...
                    <div class="col-md-6">
                        <x-forms.datepicker fieldId="date_of_return" :fieldLabel="__('cdform::app.dateOfReturn')"
...
<script>
    $(document).ready(function () {
        ...
        $('#update-return-to').click(function () {
            $.easyAjax({
                url: "{{ route('history.update', [$history->cdform_id, $history->id]) }}",
                container: '#returnTo',
                type: "POST",
                blockUI: true,
                disableButton: true,
