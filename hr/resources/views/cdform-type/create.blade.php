...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('cdform::app.cdformType')</h5>
...
<div class="modal-body">
    <x-table class="table-bordered" headType="thead-light">
        ...
        @empty
            <tr>
                <td colspan="3">@lang('cdform::app.nocdformType')</td>
            </tr>
        @endforelse
    </x-table>

    <x-form id="create-cdform-type">
...
<script>
    ...
    $('[contenteditable=true]').focus(function () {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            var url = "{{ route('cdform-type.update', ':id') }}";
            url = url.replace(':id', id);
